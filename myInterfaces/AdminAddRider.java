...
public class AdminAddRider extends JFrame {
    ...
    public AdminAddRider(String name) {
        // Frame Layout
        ...
        */
        ...
        btn1 = new JButton();
        btn1.setText("Back");
        btn1.setForeground(Color.decode("#4a7c59"));
        ...
        btn2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textField1.isEmpty() || textField2.isEmpty() || textField3.isEmpty() || textField4.isEmpty()
                    ...
                    JOptionPane.showMessageDialog(null, "Rider has been added.", "Rider Added",
    ...
    public static void main(String[] args) {
        ...
        AdminAddRider frame = new AdminAddRider("Saron");
        frame.setVisible(true);
    }
}
