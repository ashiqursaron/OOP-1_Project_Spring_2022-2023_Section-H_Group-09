...
public class ManagePassengerFrame extends JFrame {
    ...
    private String[] column = { "User Name", "Email","Password", "Mobile Number", "Gender","Nid Number","Address","Date and Time" };
    private String[] rows = new String[8];

    public ManagePassengerFrame(String name) {
        // Frame Layout
        ...
        btn1.setBackground(Color.decode("#e63946"));
        c.add(btn1);
        ...
        btn2.setBackground(Color.decode("#e63946"));
        c.add(btn2);
        ...
        btn3.setBackground(Color.decode("#e63946"));
        c.add(btn3);
        /*
        ...
        */
		...
		btn5 = new JButton();
        btn5.setText("Back");
        btn5.setForeground(Color.decode("#301934"));
        ...
        String file = ".\\Data\\passenger_data.txt";
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++) {
                ...
                if (x.equals("User")) {
					...
					rows[5] = Files.readAllLines(Paths.get(file)).get((i + 5)).substring(13); //nid number
					rows[6] = Files.readAllLines(Paths.get(file)).get((i + 6)).substring(10); //address
    ...
    public static void main(String[] args) {
        ...
        ManagePassengerFrame frame = new ManagePassengerFrame("Saron");
        frame.setVisible(true);
    }
}
