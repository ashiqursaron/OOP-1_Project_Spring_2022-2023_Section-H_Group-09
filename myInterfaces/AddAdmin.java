...
public class AddAdmin extends JFrame {
    ...
    public AddAdmin(String name) {
         ...
         * c.add(label1);
         * 
         * String[] secQsn = { "Choose a Security Question...", "Your dream job?",
         * "Your favorite song?",
        ...
        btn2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                // String secQsn = String.valueOf(securityQsn.getSelectedItem()); // Security
                // Question
                ...
                if (textField1.isEmpty() || textField2.isEmpty() || textField3.isEmpty() /*
                    ...
                    JOptionPane.showMessageDialog(null, "Admin has been added.", "Admin Added",
    ...
    public static void main(String[] args) {
        ...
        AddAdmin frame = new AddAdmin("Saron");
        frame.setVisible(true);
    }
}
