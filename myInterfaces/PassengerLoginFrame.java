...
public class PassengerLoginFrame extends JFrame /* implements ActionListener */ {
    ...
    public PassengerLoginFrame() {
        ...
        bikeLogoLabel.setForeground(Color.decode("#5a189a"));
        ...
        usernameLabel.setForeground(Color.decode("#0d1321"));
        ...
        passwordLabel.setForeground(Color.decode("#0d1321"));
        ...
        showPasswordCheckBox.setForeground(Color.decode("#5a189a"));
        ...
        loginButton.setBackground(Color.decode("#5a189a"));
        ...
        signUpButton.setForeground(Color.decode("#5a189a"));
        ...
        questionLabel.setForeground(Color.decode("#5a189a"));
        ...
        backButton.setForeground(Color.decode("#0d1321"));
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textField1.isEmpty() || textField2.isEmpty()) {
                    ...
                    try {
                        ...
                        BufferedReader reader = new BufferedReader(new FileReader(".\\Data\\passenger_data.txt"));
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            String line = Files.readAllLines(Paths.get(".\\Data\\passenger_data.txt")).get(i);
                            if (line.equals(userNameS)) {
                                String line2 = Files.readAllLines(Paths.get(".\\Data\\passenger_data.txt"))
                                        .get((i + 2));
                                if (line2.equals(passwordS)) {
                                    ...
                                    setVisible(false);
                                    PassengerDashBoard frame = new PassengerDashBoard(textField1);
