    ...
    RiderSignupFrame() {
        ...
        signupButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
				...
				String textField5 = ((JRadioButton) ae.getSource()).getText();// Gender
                ...
                if (textField5.isEmpty()) {
                    ...
                    if (textField1.isEmpty() || textField2.isEmpty() || textField3.isEmpty() || textField4.isEmpty()
                            || textField5.isEmpty()|| textField6.isEmpty() ||textField7.isEmpty()||!checkBox.isSelected()/*|| ((securityQsn.getSelectedIndex()) == 0)*/) {
                        JOptionPane.showMessageDialog(null, "Please fill all of the fields.", "Warning!",
                                JOptionPane.WARNING_MESSAGE);
                    } /*else if (result != (a + b)) {
                        ...
                        //JOptionPane.showMessageDialog(null, "RiderSignupFrame Successfully Completed.",
                            //    "RiderSignupFrame Complete", JOptionPane.WARNING_MESSAGE);
                        setVisible(false);
                        RiderLoginFrame frame = new RiderLoginFrame();
                        frame.setVisible(true);
                    }
